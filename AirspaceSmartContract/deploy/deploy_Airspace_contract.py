...
abi_file = "../contract/AirspaceReservation.abi"
bin_file = "../contract/AirspaceReservation.bin" 
...
print("Airspace Reservation Contract: {}".format(addr))
with open("contract_Airspace_address.txt", "w") as fd:
    fd.write(addr)
